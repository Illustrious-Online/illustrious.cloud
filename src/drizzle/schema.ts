import { pgTable, text, boolean, numeric, timestamp, integer, uniqueIndex, foreignKey, primaryKey } from "drizzle-orm/pg-core"
...
export const userInvoice = pgTable("UserInvoice", {
	userId: text().notNull(),
...
export const orgReport = pgTable("OrgReport", {
	...
	primaryKey({ columns: [table.orgId, table.reportId], name: "OrgReport_pkey"}),
]);
